function obj = make_arm_J1(obj)
    ...
    % Draw side patches
    obj.armJ1V.sides.x =  PatchData1_X + 0.4/2 - 0.05;
    obj.armJ1V.sides.y =  PatchData1_Y + 0.4/3;
    obj.armJ1V.sides.z =  PatchData1_Z + 0.5;
    obj.armJ1p.sides = patch(obj.armJ1V.sides.x,obj.armJ1V.sides.y,obj.armJ1V.sides.z,obj.color);
    
    % Draw bottom patches
    obj.armJ1V.topbottom.x =  PatchData2_X + 0.4/2 -0.05;
    obj.armJ1V.topbottom.y =  PatchData2_Y + 0.4/3;
    obj.armJ1V.topbottom.z =  PatchData2_Z + 0.5;
    
    obj.armJ1p.topbottom = patch(obj.armJ1V.topbottom.x,obj.armJ1V.topbottom.y,obj.armJ1V.topbottom.z,obj.color);
end