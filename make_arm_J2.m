function obj = make_arm_J2(obj)
    ...
    % Draw side patches
    obj.armJ2V.sides.x =  PatchData1_X + 0.4/2 - 0.05;
    obj.armJ2V.sides.y =  PatchData1_Y + 0.4/3;
    obj.armJ2V.sides.z =  PatchData1_Z + 0.8;
    obj.armJ2p.sides = patch(obj.armJ2V.sides.x,obj.armJ2V.sides.y,obj.armJ2V.sides.z,obj.color);
    
    % Draw bottom patches
    obj.armJ2V.topbottom.x =  PatchData2_X + 0.4/2 -0.05;
    obj.armJ2V.topbottom.y =  PatchData2_Y + 0.4/3;
    obj.armJ2V.topbottom.z =  PatchData2_Z + 0.8;
    
    obj.armJ2p.topbottom = patch(obj.armJ2V.topbottom.x,obj.armJ2V.topbottom.y,obj.armJ2V.topbottom.z,obj.color);
end